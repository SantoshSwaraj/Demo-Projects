...
public class PolicyManagementMapperList {

	private List<PolicyManagementDTO> data=new ArrayList<>();
	
	public PolicyManagementMapperList(List<PolicyManagementDTO> pml) {
		this.data=pml;
	}
