...
public class PolicyManagementPrismaCloudMapperList {

	private List<PolicyManagementPrismaCloudDTO> data=new ArrayList<>();
	
	public PolicyManagementPrismaCloudMapperList(List<PolicyManagementPrismaCloudDTO> resultList) {
