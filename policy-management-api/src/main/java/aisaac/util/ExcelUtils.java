...
public class ExcelUtils {
	...
	public static String getFileName(String start, String subFileName, String dateTime
		...
		String fileName = AppConstants.POLICY_MANAGEMENT_FILENAME_PREFIX + start
				+ AppConstants.POLICY_MANAGEMENT_SEPARATOR_UNDERSCORE + subFileName
				+ AppConstants.POLICY_MANAGEMENT_SEPARATOR_UNDERSCORE + dateTime;

		if (moreThanOnePartsAvailable) {
			fileName += AppConstants.POLICY_MANAGEMENT_FILENAME_SEPARATOR_PART + number
					+ (itIsLastPart ? AppConstants.POLICY_MANAGEMENT_FILENAME_SEPARATOR_LAST : StringUtils.EMPTY)
					+ extension;
		}
		...
		fileName += AppConstants.POLICY_MANAGEMENT_FILENAME_SUFFIX;

		return fileName;

	}
	
//	public static Excel createExcelFromExcelBeanFactory(String className) {
//		
//		ExcelBeanFactory excelBeanFactory = new ExcelBeanFactory();
//		
//		return excelBeanFactory.createExcel(className);
//	}
//	
//	public static Excel createExcelFromExcelBeanFactory(String className, List<Object> data) {
//		
//		ExcelBeanFactory excelBeanFactory = new ExcelBeanFactory();
//		
//		return excelBeanFactory.createExcel(className, data);
//	}
//	
	...
	public static String downloadToPath(Excel excel, String path, String fileName) throws IOException {
		...
		path= path+AppConstants.POLICY_MANAGEMENT_FILENAME_FORWARD_SLASH+fileName;
//		ServletOutputStream outputStream = response.getOutputStream();
