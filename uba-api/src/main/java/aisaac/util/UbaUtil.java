...
public class UbaUtil {
	...
	public static String getUserNameWithType(String userName, String type) {
		if (StringUtils.isNotBlank(type) && type.toUpperCase().contains(AppConstants.PARAM_SOURCE_TYPE)) {
			return userName + StringUtils.SPACE + AppConstants.OPEN_PARENTHESES + AppConstants.PARAM_SOURCE
					+ AppConstants.CLOSE_PARENTHESES;
		} else if (StringUtils.isNotBlank(type) && type.toUpperCase().contains(AppConstants.PARAM_DESTINATION_TYPE)) {
			return userName + StringUtils.SPACE + AppConstants.OPEN_PARENTHESES + AppConstants.PARAM_DESTINATION
					+ AppConstants.CLOSE_PARENTHESES;
		}
		return userName;
	}
